...
//const sessionStore2 = new MongoSessionStore({ url: credentials.mongo[app.get('env')].connectionString });
...
const db = mongoose.createConnection(credentials.mongo[app.get('env')].connectionString, { useUnifiedTopology: true, useNewUrlParser: true });
const sessionStore = db.startSession();
//const sessions = sessionStore
app.use(require('cookie-parser')(credentials.cookieSecret));
app.use(session({

    cookie: {},
    store: new MemoryStore({ sessionStore }),
        ...
        locations: [
            {
                ...
                iconUrl: 'https://media3.giphy.com/media/gs2ubveMcc2zPVNceK/giphy.gif?cid=790b7611308038116b1d465a9773adc72924a6c70a68be61&rid=giphy.gif&ct=g',
                weather: 'Overcast',
                temp: '54.1 F (12.3 C)',
            },
            {
                ...
                iconUrl: 'https://64.media.tumblr.com/tumblr_licelpVslZ1qcgu4io1_500.gifv',
            ...
            },
            {
                ...
                iconUrl: 'https://media4.giphy.com/media/v0R4uwLqGKvQY/giphy.gif?cid=ecf05e47zk9rzffwk1l0gyi8vurv751wctsyppzjpzjtfrmk&rid=giphy.gif&ct=g',
                weather: 'Light Rain',
                temp: '55.0 F (12.8 C)',
            },
        ],
...
app.post('/cart/add', function (req, res, next) {
    ...
    Vacation.findOne({ sku: dados.sku }, function (err, vacation) {
        if (err)
            return next(err);
        if (!vacation)
            return next(new Error('Unknown vacation SKU: ' + dados.sku));
        cart.items.push({
            vacation: vacation,
